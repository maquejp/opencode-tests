              ...
              <div className="relative bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-8 hover-lift border border-accent-100">
                <div className="flex flex-wrap justify-between items-start mb-6">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        ...
                        <p className="text-lg text-accent-600 font-medium">{edu.institution}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-right">
                    <div className="glass-effect px-4 py-2 rounded-full mb-2">
                      <p className="text-sm font-semibold text-accent-700">{edu.duration}</p>
                    </div>
                ...
                {edu.achievements && edu.achievements.length > 0 && (
                  <div className="pt-6 border-t border-accent-100">
                    <p className="text-sm font-semibold text-accent-600 mb-3">Key Achievements:</p>
